...
void ObjectCreator::createRandomlyAppearingEntities(int* PositionOfVampiresLasers)
{
    ...
    if (chanceOfAnObjectAppearing <= 10)
    {
        ...
        {
            case 0:
                entity = new Bat({0, 0, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 165, returnArrayOfArrays(0));
                break;
            case 1:
                entity = new Cat({60, 0, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 289, returnArrayOfArrays(1));
                break;
            case 2:
                entity = new Fly({120, 0, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 165, returnArrayOfArrays(2));
                break;
            case 3:
                entity = new Garlic({0, 60, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 98, returnArrayOfArrays(3));
                break;
            case 4:
                entity = new JarOfBlood({60, 60, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 155, returnArrayOfArrays(4));
                break;
            case 5:
                entity = new Knife({120, 60, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 139, returnArrayOfArrays(5));
                break;
            case 6:
                entity = new Laser({0, 120, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 146, returnArrayOfArrays(6));
                break;
            case 7:
                entity = new Onion({60, 120, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 141, returnArrayOfArrays(7));
                break;
            case 8:
                entity = new Timer({120, 120, 60, 60}, {762, 400, 60, 60}, RANDOMLY_APPEARING_ENTITY, 159, returnArrayOfArrays(8));
                break;
            default:
                break;
        }
